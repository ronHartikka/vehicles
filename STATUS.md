...
19. ✅ Figure-8 behavior with two sources. Two identical sources (intensity=400000) separated by 125 units (~1.5x orbital diameter). The bell-curve vehicle naturally transitions between orbiting each source, producing a stable figure-8 trajectory. At closer separation (85, ≈ orbital diameter) the path is a symmetric oval around both sources.
